...
def system_status() -> dict[str, object]:
    ...
    return {
        ...
        "frontend_runtime": "Vercel" if settings.is_managed_cloud else "Local Next.js",
        "backend_runtime": "Vercel Python Serverless" if settings.is_serverless else "FastAPI",
        "queue_backend": settings.queue_backend,
        "rhd_status": "active",
        "local_ollama": "development_only" if settings.is_managed_cloud else "available_when_configured",
